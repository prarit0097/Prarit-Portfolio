...
export function AboutSection() {
  ...
  // Content rendered without any framer-motion wrappers
  const aboutContent = (
    <div className="glass-card p-6 md:p-8 lg:p-12 relative group">
  ...
  // Animated version with framer-motion (desktop / high-end devices)
  ...
  // Static version (mobile / low-end devices) — no motion at all
  const staticContent = (
